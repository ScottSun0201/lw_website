...
func Routers() *gin.Engine {
...

	{
...

		{
			...
			cmsRouter.InitCmsPlateRouter(PrivateGroup, PublicGroup)
			cmsRouter.InitCmsBannerRouter(PrivateGroup)
			cmsRouter.InitCmsFriendRouter(PrivateGroup, PublicGroup)
			cmsRouter.InitCmsTagRouter(PrivateGroup, PublicGroup)
			cmsRouter.InitCmsArticleRouter(PrivateGroup, PublicGroup)
			cmsRouter.InitCmsCommitRouter(PrivateGroup, PublicGroup)
		}
		{
		...
		}
		{
			...
			shopRouter.InitShopCategoryRouter(PrivateGroup, PublicGroup)
			...
			shopRouter.InitShopAnalyticsRouter(PrivateGroup)
		}
