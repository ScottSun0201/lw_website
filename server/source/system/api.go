...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "模型", Method: "POST", Path: "/cmsModel/createCmsModel", Description: "新增模型"},
		{ApiGroup: "模型", Method: "DELETE", Path: "/cmsModel/deleteCmsModel", Description: "删除模型"},
		{ApiGroup: "模型", Method: "DELETE", Path: "/cmsModel/deleteCmsModelByIds", Description: "批量删除模型"},
		{ApiGroup: "模型", Method: "PUT", Path: "/cmsModel/updateCmsModel", Description: "更新模型"},
		{ApiGroup: "模型", Method: "GET", Path: "/cmsModel/findCmsModel", Description: "根据ID获取模型"},
		{ApiGroup: "模型", Method: "GET", Path: "/cmsModel/getCmsModelList", Description: "获取模型列表"},
		{ApiGroup: "板块", Method: "POST", Path: "/cmsPlate/createCmsPlate", Description: "新增板块"},
		{ApiGroup: "板块", Method: "DELETE", Path: "/cmsPlate/deleteCmsPlate", Description: "删除板块"},
		{ApiGroup: "板块", Method: "DELETE", Path: "/cmsPlate/deleteCmsPlateByIds", Description: "批量删除板块"},
		{ApiGroup: "板块", Method: "PUT", Path: "/cmsPlate/updateCmsPlate", Description: "更新板块"},
		{ApiGroup: "板块", Method: "GET", Path: "/cmsPlate/findCmsPlate", Description: "根据ID获取板块"},
		{ApiGroup: "板块", Method: "GET", Path: "/cmsPlate/getCmsPlateList", Description: "获取板块列表"},
		{ApiGroup: "轮播图", Method: "POST", Path: "/cmsBanner/createCmsBanner", Description: "新增轮播图"},
		{ApiGroup: "轮播图", Method: "DELETE", Path: "/cmsBanner/deleteCmsBanner", Description: "删除轮播图"},
		{ApiGroup: "轮播图", Method: "DELETE", Path: "/cmsBanner/deleteCmsBannerByIds", Description: "批量删除轮播图"},
		{ApiGroup: "轮播图", Method: "PUT", Path: "/cmsBanner/updateCmsBanner", Description: "更新轮播图"},
		{ApiGroup: "轮播图", Method: "GET", Path: "/cmsBanner/findCmsBanner", Description: "根据ID获取轮播图"},
		{ApiGroup: "轮播图", Method: "GET", Path: "/cmsBanner/getCmsBannerList", Description: "获取轮播图列表"},
		{ApiGroup: "友情链接", Method: "POST", Path: "/cmsFriend/createCmsFriend", Description: "新增友情链接"},
		{ApiGroup: "友情链接", Method: "DELETE", Path: "/cmsFriend/deleteCmsFriend", Description: "删除友情链接"},
		{ApiGroup: "友情链接", Method: "DELETE", Path: "/cmsFriend/deleteCmsFriendByIds", Description: "批量删除友情链接"},
		{ApiGroup: "友情链接", Method: "PUT", Path: "/cmsFriend/updateCmsFriend", Description: "更新友情链接"},
		{ApiGroup: "友情链接", Method: "GET", Path: "/cmsFriend/findCmsFriend", Description: "根据ID获取友情链接"},
		{ApiGroup: "友情链接", Method: "GET", Path: "/cmsFriend/getCmsFriendList", Description: "获取友情链接列表"},
		{ApiGroup: "标签", Method: "POST", Path: "/cmsTag/createCmsTag", Description: "新增标签"},
		{ApiGroup: "标签", Method: "DELETE", Path: "/cmsTag/deleteCmsTag", Description: "删除标签"},
		{ApiGroup: "标签", Method: "DELETE", Path: "/cmsTag/deleteCmsTagByIds", Description: "批量删除标签"},
		{ApiGroup: "标签", Method: "PUT", Path: "/cmsTag/updateCmsTag", Description: "更新标签"},
		{ApiGroup: "标签", Method: "GET", Path: "/cmsTag/findCmsTag", Description: "根据ID获取标签"},
		{ApiGroup: "标签", Method: "GET", Path: "/cmsTag/getCmsTagList", Description: "获取标签列表"},
		{ApiGroup: "文章", Method: "POST", Path: "/cmsArticle/createCmsArticle", Description: "新增文章"},
		{ApiGroup: "文章", Method: "DELETE", Path: "/cmsArticle/deleteCmsArticle", Description: "删除文章"},
		{ApiGroup: "文章", Method: "DELETE", Path: "/cmsArticle/deleteCmsArticleByIds", Description: "批量删除文章"},
		{ApiGroup: "文章", Method: "PUT", Path: "/cmsArticle/updateCmsArticle", Description: "更新文章"},
		{ApiGroup: "文章", Method: "GET", Path: "/cmsArticle/findCmsArticle", Description: "根据ID获取文章"},
		{ApiGroup: "文章", Method: "GET", Path: "/cmsArticle/getCmsArticleList", Description: "获取文章列表"},
		...
		{ApiGroup: "客户端SEO", Method: "POST", Path: "/clientSEO/createClientSEO", Description: "新增客户端SEO"},
		{ApiGroup: "客户端SEO", Method: "GET", Path: "/clientSEO/findClientSEO", Description: "根据ID获取客户端SEO"},
		{ApiGroup: "友情链接", Method: "POST", Path: "/cmsFriend/setCmsFriendInfo", Description: "设置友情链接基本信息"},
		{ApiGroup: "关于我们", Method: "POST", Path: "/clientAbout/createClientAbout", Description: "新增关于我们"},
		{ApiGroup: "关于我们", Method: "DELETE", Path: "/clientAbout/deleteClientAbout", Description: "删除关于我们"},
		{ApiGroup: "关于我们", Method: "DELETE", Path: "/clientAbout/deleteClientAboutByIds", Description: "批量删除关于我们"},
		{ApiGroup: "关于我们", Method: "PUT", Path: "/clientAbout/updateClientAbout", Description: "更新关于我们"},
		{ApiGroup: "关于我们", Method: "GET", Path: "/clientAbout/findClientAbout", Description: "根据ID获取关于我们"},
		{ApiGroup: "关于我们", Method: "GET", Path: "/clientAbout/getClientAboutList", Description: "获取关于我们列表"},
		{ApiGroup: "关于我们", Method: "POST", Path: "/clientAbout/setClientAboutInfo", Description: "设置关于我们信息"},
		{ApiGroup: "评论", Method: "POST", Path: "/cmsCommit/createCmsCommit", Description: "新增评论"},
		{ApiGroup: "评论", Method: "DELETE", Path: "/cmsCommit/deleteCmsCommit", Description: "删除评论"},
		{ApiGroup: "评论", Method: "DELETE", Path: "/cmsCommit/deleteCmsCommitByIds", Description: "批量删除评论"},
		{ApiGroup: "评论", Method: "PUT", Path: "/cmsCommit/updateCmsCommit", Description: "更新评论"},
		{ApiGroup: "评论", Method: "GET", Path: "/cmsCommit/findCmsCommit", Description: "根据ID获取评论"},
		{ApiGroup: "评论", Method: "GET", Path: "/cmsCommit/getCmsCommitList", Description: "获取评论列表"},
	}
