...
func (s *DictionaryRouter) InitSysDictionaryRouter(Router, PublicRouter *gin.RouterGroup) {
	sysDictionaryRouter := Router.Group("sysDictionary").Use(middleware.OperationRecord())
	sysDictionaryRouterWithoutRecord := Router.Group("sysDictionary")
	sysDictionaryRouterWithoutRole := PublicRouter.Group("sysDictionary")
	{
	...
	{
		sysDictionaryRouterWithoutRole.GET("findSysDictionary", dictionaryApi.FindSysDictionary) // 根据ID获取SysDictionary
	}
}
