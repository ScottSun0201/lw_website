...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/clientAbout/createClientAbout", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/clientAbout/deleteClientAbout", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/clientAbout/deleteClientAboutByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/clientAbout/findClientAbout", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/clientAbout/getClientAboutList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/clientAbout/setClientAboutInfo", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/clientAbout/updateClientAbout", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/clientSEO/createClientSEO", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/clientSEO/findClientSEO", V2: "GET"},
		...
		{Ptype: "p", V0: "888", V1: "/cmsArticle/createCmsArticle", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/cmsArticle/deleteCmsArticle", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsArticle/deleteCmsArticleByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsArticle/findCmsArticle", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsArticle/getCmsArticleList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsArticle/updateCmsArticle", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/cmsBanner/createCmsBanner", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/cmsBanner/deleteCmsBanner", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsBanner/deleteCmsBannerByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsBanner/findCmsBanner", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsBanner/getCmsBannerList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsBanner/updateCmsBanner", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/cmsFriend/createCmsFriend", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/cmsFriend/deleteCmsFriend", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsFriend/deleteCmsFriendByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsFriend/findCmsFriend", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsFriend/getCmsFriendList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsFriend/setCmsFriendInfo", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/cmsFriend/updateCmsFriend", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/cmsPlate/createCmsPlate", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/cmsPlate/deleteCmsPlate", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsPlate/deleteCmsPlateByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsPlate/findCmsPlate", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsPlate/getCmsPlateList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsPlate/updateCmsPlate", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/cmsTag/createCmsTag", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/cmsTag/deleteCmsTag", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsTag/deleteCmsTagByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/cmsTag/findCmsTag", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsTag/getCmsTagList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/cmsTag/updateCmsTag", V2: "PUT"},
		...
		// 8080 客户端权限
		{Ptype: "p", V0: "8080", V1: "/cmsCommit/createCmsCommit", V2: "POST"},
		{Ptype: "p", V0: "8080", V1: "/fileUploadAndDownload/upload", V2: "POST"},
		{Ptype: "p", V0: "8080", V1: "/jwt/jsonInBlacklist", V2: "POST"},
		{Ptype: "p", V0: "8080", V1: "/menu/getMenu", V2: "POST"},
		{Ptype: "p", V0: "8080", V1: "/sysDictionary/findSysDictionary", V2: "GET"},
		{Ptype: "p", V0: "8080", V1: "/sysDictionary/getSysDictionaryList", V2: "GET"},
		{Ptype: "p", V0: "8080", V1: "/sysDictionaryDetail/findSysDictionaryDetail", V2: "GET"},
		{Ptype: "p", V0: "8080", V1: "/sysDictionaryDetail/getSysDictionaryDetailList", V2: "GET"},
		{Ptype: "p", V0: "8080", V1: "/user/admin_register", V2: "POST"},
		{Ptype: "p", V0: "8080", V1: "/user/changePassword", V2: "POST"},
		{Ptype: "p", V0: "8080", V1: "/user/getUserInfo", V2: "GET"},
		{Ptype: "p", V0: "8080", V1: "/user/setUserAuthority", V2: "POST"},
		{Ptype: "p", V0: "8080", V1: "/user/setUserInfo", V2: "PUT"},
	}
