...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "enterpriseCMS", Name: "enterpriseCMS", Component: "view/routerHolder.vue", Sort: 1000, Meta: Meta{Title: "企业CMS", Icon: "notebook"}},
		{MenuLevel: 0, Hidden: false, ParentId: 30, Path: "cmsArticle", Name: "cmsArticle", Component: "view/cmsArticle/cmsArticle.vue", Sort: 0, Meta: Meta{Title: "文章管理", Icon: "notebook"}},
		{MenuLevel: 0, Hidden: false, ParentId: 30, Path: "cmsBanner", Name: "cmsBanner", Component: "view/cmsBanner/cmsBanner.vue", Sort: 1, Meta: Meta{Title: "轮播管理", Icon: "picture-filled"}},
		{MenuLevel: 0, Hidden: false, ParentId: 30, Path: "cmsFriend", Name: "cmsFriend", Component: "view/cmsFriend/cmsFriend.vue", Sort: 2, Meta: Meta{Title: "友链管理", Icon: "user-filled"}},
		{MenuLevel: 0, Hidden: false, ParentId: 30, Path: "cmsPlate", Name: "cmsPlate", Component: "view/cmsPlate/cmsPlate.vue", Sort: 3, Meta: Meta{Title: "板块管理", Icon: "place"}},
		{MenuLevel: 0, Hidden: false, ParentId: 30, Path: "cmsTag", Name: "cmsTag", Component: "view/cmsTag/cmsTag.vue", Sort: 4, Meta: Meta{Title: "标签管理", Icon: "collection-tag"}},
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "cmsClientAdmin", Name: "cmsClientAdmin", Component: "view/routerHolder.vue", Sort: 2000, Meta: Meta{Title: "C端管理", Icon: "folder-opened"}},
		{MenuLevel: 0, Hidden: false, ParentId: 36, Path: "clientUser", Name: "clientUser", Component: "view/clientUser/clientUser.vue", Sort: 0, Meta: Meta{Title: "CMS客户管理", Icon: "paperclip"}},
		{MenuLevel: 0, Hidden: false, ParentId: 36, Path: "clientSeo", Name: "clientSeo", Component: "view/clientSeo/clientSeoForm.vue", Sort: 1, Meta: Meta{Title: "SEO配置", Icon: "search"}},
		{MenuLevel: 0, Hidden: false, ParentId: 36, Path: "cmsAbout", Name: "cmsAbout", Component: "view/clientAbout/clientAbout.vue", Sort: 2, Meta: Meta{Title: "设置关于", Icon: "user-filled"}},
